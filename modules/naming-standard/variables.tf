...
# Pass in dynamically based on spoke name in the global_settings.tfvars.
# e.g. org/spoke1/global_settings.tfvars would have a var set for its naming standard. Same for spoke 2 etc etc
variable "sub" {
  type        = string
